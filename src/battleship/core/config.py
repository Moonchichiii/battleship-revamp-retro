...
# --- OAuth Enabled Flags ---
GITHUB_OAUTH_ENABLED: Final[bool] = bool(GITHUB_CLIENT_ID and GITHUB_CLIENT_SECRET)
GOOGLE_OAUTH_ENABLED: Final[bool] = bool(GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET)
